...
abstract class _$_SignUpProcessCWProxy {
  ...
  _SignUpProcess hasNumber(bool hasNumber);

  _SignUpProcess isMatching(bool isMatching);
  ...
  _SignUpProcess firstName(String? firstName);
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOf_SignUpProcess.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOf_SignUpProcess.copyWith.fieldName(...)`
class _$_SignUpProcessCWProxyImpl implements _$_SignUpProcessCWProxy {
  ...
  _SignUpProcess call({
    ...
    Object? hasLowerUpperCase = const $CopyWithPlaceholder(),
    ...
    return _SignUpProcess(
      ...
      hasNumber: hasNumber == const $CopyWithPlaceholder() || hasNumber == null
          ? _value.hasNumber
          // ignore: cast_nullable_to_non_nullable
          : hasNumber as bool,
      isMatching:
...
extension _$_SignUpProcessCopyWith on _SignUpProcess {
  /// Returns a callable class that can be used as follows: `instanceOf_SignUpProcess.copyWith(...)` or like so:`instanceOf_SignUpProcess.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$_SignUpProcessCWProxy get copyWith => _$_SignUpProcessCWProxyImpl(this);
}
